...
exapp.get('/content/wknd-events/react*.html', (req, res, next) => {
    ...
    const modelClient = new CustomModelClient(process.env.API_HOST);
...
exapp.post("/content/wknd-events/react*.html", (req, res, next) => {
